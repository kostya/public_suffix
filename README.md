# Public Suffix <small>for Crystal</small>

<tt>PublicSuffix</tt> is a Crystal domain name parser based on the [Public Suffix List](https://publicsuffix.org/). Translated from ruby: https://github.com/weppos/publicsuffix-ruby.
...
```crystal
domain = PublicSuffix.parse("google.co.uk")
# => #<PublicSuffix::Domain>
domain.tld
# => "co.uk"
domain.sld
